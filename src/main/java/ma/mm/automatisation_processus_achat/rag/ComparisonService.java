...
public class ComparisonService {
    ...
    Les pages de l'offre fournisseur contiennent la marque qui correspond au poste.
    Pour chaque poste du CPS, indique :
    - CONFORME si la marque de la fourniture dans l'offre fournisseur est adequate au poste qui est dans le CPS
    - NON CONFORME
